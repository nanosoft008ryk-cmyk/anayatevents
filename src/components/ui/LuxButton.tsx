...
const base =
  "group/lux relative isolate inline-flex items-center justify-center overflow-hidden px-9 py-[1.15rem] font-sans text-[11px] font-normal tracking-[0.3em] uppercase transition-[transform,color,box-shadow] duration-500 [transition-timing-function:var(--ease-lux)] will-change-transform";
